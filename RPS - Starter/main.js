...
function setNames(){
    ...
    var computer = prompt("please enter the name for your #1 enemy");

    document.getElementById('p-name').innerHTML = human;
    
    document.getElementById('c-name').innerHTML = computer;
...
function getWinner(){
    let human = document.getElementById('p-name').human;
    let computer = document.getElementById('c-name').computer;
    if (cPick == 'rock' && pPick == 'paper') {

        document.getElementById('winner-text').innerHTML = human + ' won!';
    ...
    }else if (cPick == 'paper' && pPick == 'scissors') {
    ...
    }else if (cPick == 'scissors' && pPick == 'rock') {
...
function updateScoreArea(pPlayer, cPlayer){
    if(pPlayer == 'rock' && cPlayer == 'scissors' || pPlayer == 'scissors' && cPlayer == 'paper' || pPlayer == 'paper' || cPlayer =='rock') {

        pScore += 1;

        document.getElementById('p-score').innerHTML = pscore

    }else if (pPlayer == 'scissors' && cPlayer == 'rock' || pPlayer == 'paper' && cPlayer == 'scissors' || pPlayer == 'rock' || cPlayer =='paper') {
